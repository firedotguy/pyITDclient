...
from itd.exceptions import NotFoundError, TooLargeError
...
@rate_limit()
@api_wrapper(TooLargeError('Hashtag'), NotFoundError('Hashtag', json_check=lambda json: json.get('data', {}).get('hashtag', '') is None))
